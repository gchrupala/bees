...
Each colony has five heritable mean traits: directional precision investment,
...
precision, motivation, or dance duration. In this minimal model, the same trait
sets the angular concentration of a produced dance and the per-dance cost paid
by the colony. The biological assumption is therefore that more precise
directional signaling requires greater effort. This coupling keeps the model
small, but it limits the interpretation: the results show the evolution of
costly signal precision, not the separate evolution of intrinsic accuracy and
signaling effort. A cleaner extension would give colonies distinct traits for
produced signal accuracy and signaling effort or cost.
...
and receiver transposition, and search limit, plus forager success rate across
generations.
...
directional precision investment, and an attention cost of 0.01 for each worker
that follows a dance. Thus more precise directional signaling, more
dance-following, and longer search effort can increase food collection, but
they are not free. The current model
