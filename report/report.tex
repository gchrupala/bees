...
unit, and food-site value was 1.0. All three conditions used food-site capacity
6. The conditions varied only the number and angular width of food sites: hard
...
model. ``Reached'' is the number of seeds in which mean directional bias reached
0.30 by generation 30. ``Reach gen.'' is averaged over reached seeds only.
Bias, attention, search limit, success, and payoff are final-generation means
over all ten seeds.}
...
to seed recruitment cascades, and directional bias, receiver attention, and
search limit all rise strongly. In the easy environment, success and payoff are
high, but directional bias and receiver attention remain much lower than in the
...
generations: only half of the seeds reach the directional-bias threshold, and
final payoff is close to the minimum floor.
