...
shrinks, reaching its minimum $\cos\theta$ for food in the direction the comb
...
reference. Its strength depends only on tilt, not on the food's bearing,
\begin{equation}
...
When a code's strength is below $1$, the direction it recovers is correspondingly
