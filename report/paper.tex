...
The first experiment uses the horizontal-comb model of \Cref{sec:horizontal}: comb
...
The second experiment uses the full model of \Cref{sec:vertical}: \trait{comb tilt} $\gamma$
...
\emph{large} a viable region is. The sub-experiments below therefore re-examine
...
the \emph{non-viable} fraction (foraging success $\le 0.02$ at its worst
