...
receiver corrects for comb orientation, and we model two decoders
(\Cref{sec:vertical}): a more biologically plausible \emph{flatten} decoder that
applies no such correction and is therefore biased on a tilted comb, and an
idealized \emph{unproject} decoder that corrects exactly and serves as a
bias-free reference against which to read the  results of \emph{flatten}.
