...
of the referent. The ancestral, direct-pointing dance has been characterized as a
symbolic enactment of the foraging flight, in which the waggle run re-enacts the
departure direction toward the food \citep{10.1242/jeb.142778}. The
...
pointing are the ancestral state (extant in stem \emph{Micrapis} subgenus), a
mapping of dance form onto this phylogeny also drawn by \citet{10.1242/jeb.142778}.
Vertical
...
that represents heading is not tied to any particular spatial reference frame, so
...
addresses how an individual brain could support either version of the code, but
not how a population of senders and receivers stays coordinated while the shared
code itself changes, which is the question we address.
