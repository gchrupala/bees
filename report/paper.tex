...
trials in total across sixteen parallel workers evaluated against a single
shared study, each worker seeded independently and drawing $64$ startup random
trials. Each trial evaluates a panel of $J = 10$ seeds ($100$--$109$). For seed $j$ we write
