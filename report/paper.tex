...
whose radius is drawn from a lognormal of median $150$ m; capacity scales with
patch area from a base of $6$ loads at the median radius, and the number of
patches per episode is Poisson (\Cref{sec:environment}). Each foray draws its
...
\begin{table}
  ...
  \begin{tabular}{ll}
    ...
    $\rho_r$        & median patch radius (m, lognormal) \\
