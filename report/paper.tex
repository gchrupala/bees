...
\begin{table}
  ...
  \begin{tabular}{@{}llll@{}}
    \toprule
    Approach & Code adapts by & Unit & Question \\
    \midrule
    Signaling games and RL  & learning / evolution  & population       & emergence \\
    Iterated learning       & cultural transmission & generations      & emergence \\
  ...
  \caption{Computational approaches to how a communicative code arises or
    ...
    the code adapts (if at all), the unit it applies to, and the question each
    line of work asks. Each row is discussed and cited in the text.}
  \label{tab:routes}
\end{table}
