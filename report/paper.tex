...
pointing are the ancestral state, extant in stem \emph{Micrapis} subgenus.
Vertical
...
search alone: it appears across a band spanning few large patches through many
small ones, and fails only when food is too sparse to seed dances or so abundant
that it is found without help. The colony-level benefit of the dance, by contrast,
is largest for few, large patches.
...
\begin{figure}
  ...
  \label{fig:food-grid}
\end{figure}
\todo{GC: Swap the order of the panels in the fig:food-grid and adjust the caption and text accordingly.}
\todo{GC: Make font sizes larger in this figure, and subsequent figures, such that they readable are not dramatically 
smaller than fonts in the main text.}
