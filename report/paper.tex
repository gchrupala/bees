...
$\mathbf{f} = (\cos \alpha, \sin \alpha, 0)$ for food azimuth $\alpha$ (the vertical component
...
coordinates $(p_1,p_2)^\top = M(\cos \alpha,\sin \alpha)^\top$, i.e.\ the in-surface vector
...
faces ($\alpha = \phi$); only on a fully vertical comb does this minimum reach zero,
