...
uniformly between $d_{\min}^2$ and $d_{\max}^2$. A
...
perfect accuracy. All lengths follow a fixed convention (distances in kilometers,
patch radii in meters): the maximum search distance is $D = 6$ km and food
