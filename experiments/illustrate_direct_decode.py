...
def main() -> None:
    ...
    # The paper includes the vector PDF; the PNG is kept for quick viewing
    # and slides, matching the convention of the result-figure scripts.
    fig.savefig(args.output, dpi=190, bbox_inches="tight", pad_inches=0.05)
    fig.savefig(args.output.with_suffix(".pdf"), bbox_inches="tight", pad_inches=0.05)
